...
export class AbandonedCartClient {
  ...
  ): Observable<ResultOfPagedResultOfAbandonedCartDto> {
          ...
          if (response_ instanceof HttpResponseBase) {
            try {
              ...
              return _observableThrow(
                e
              ) as any as Observable<ResultOfPagedResultOfAbandonedCartDto>;
            }
          } else
            return _observableThrow(
              response_
  ...
  protected processGetUnnotifiedCarts(
...
export class CartClient {
  ...
  getWishlistItems(
    ...
    hasSearch: boolean | undefined,
    hasSorting: boolean | undefined
  ): Observable<ResultOfPagedResultOfWishlistItemDto> {
      ...
      .pipe(
        _observableCatch((response_: any) => {
          if (response_ instanceof HttpResponseBase) {
            ...
            return _observableThrow(
              response_
            ) as any as Observable<ResultOfPagedResultOfWishlistItemDto>;
        })
      );
  }
...
export class CategoryClient {
  ...
  createCategoryWithFile(
    ...
    else content_.append('DisplayOrder', displayOrder.toString());
  ...
  protected processCreateCategoryWithFile(
    response: HttpResponseBase
  ): Observable<ResultOfCreateCategoryResponse> {
    const status = response.status;
    const responseBlob =
...
export class ProductClient {
      ...
      .pipe(
        _observableCatch((response_: any) => {
          if (response_ instanceof HttpResponseBase) {
            ...
            return _observableThrow(
              response_
            ) as any as Observable<ResultOfGetProductBySkuResponse>;
        })
      );
  }

  protected processGetBySku(
    response: HttpResponseBase
  ): Observable<ResultOfGetProductBySkuResponse> {
    const status = response.status;
    const responseBlob =
      response instanceof HttpResponse
        ? response.body
      ...
      .pipe(
        _observableCatch((response_: any) => {
          if (response_ instanceof HttpResponseBase) {
            ...
            return _observableThrow(
              response_
            ) as any as Observable<ResultOfGetProductBySlugResponse>;
        })
      );
  }

  protected processGetBySlug(
    response: HttpResponseBase
  ): Observable<ResultOfGetProductBySlugResponse> {
    const status = response.status;
    const responseBlob =
      response instanceof HttpResponse
        ? response.body
  ...
  updateWithFiles(
    ...
    metaTitle: string | null | undefined,
    metaDescription: string | null | undefined,
    newImageFiles: FileParameter[] | null | undefined,
    newImageAltTexts: string[] | null | undefined,
    newImageDisplayOrders: number[] | null | undefined,
    newImageIsPrimary: boolean[] | null | undefined,
    imageIdsToDelete: string[] | null | undefined,
    variants: CreateProductVariantRequest[] | null | undefined,
    attributes: CreateProductAttributeValueRequest[] | null | undefined,
    tagIds: string[] | null | undefined
  ): Observable<ResultOfUpdateProductResponse> {
    ...
    else content_.append('ProductId', productId.toString());
    if (name === null || name === undefined)
      throw new globalThis.Error("The parameter 'name' cannot be null.");
    else content_.append('Name', name.toString());
    if (slug !== null && slug !== undefined) content_.append('Slug', slug.toString());
    ...
    if (newImageFiles !== null && newImageFiles !== undefined)
      newImageFiles.forEach((item_) =>
        content_.append(
          'NewImageFiles',
          item_.data,
          item_.fileName ? item_.fileName : 'NewImageFiles'
        )
      );
    ...
    if (newImageDisplayOrders !== null && newImageDisplayOrders !== undefined)
      newImageDisplayOrders.forEach((item_) =>
        content_.append('NewImageDisplayOrders', item_.toString())
      );
  ...
  protected processUpdateWithFiles(
    response: HttpResponseBase
  ): Observable<ResultOfUpdateProductResponse> {
    const status = response.status;
    const responseBlob =
  ...
  ): Observable<ResultOfGetFeaturedProductsResponse> {
      ...
      .pipe(
        _observableCatch((response_: any) => {
          if (response_ instanceof HttpResponseBase) {
            ...
            return _observableThrow(
              response_
            ) as any as Observable<ResultOfGetFeaturedProductsResponse>;
        })
      );
  }

  protected processGetFeatured(
    response: HttpResponseBase
  ): Observable<ResultOfGetFeaturedProductsResponse> {
    const status = response.status;
    const responseBlob =
  ...
  getActive(
    ...
    sortBy: string | null | undefined,
    sortDirection: string | null | undefined
  ): Observable<ResultOfGetActiveProductsResponse> {
      ...
      .pipe(
        _observableCatch((response_: any) => {
          if (response_ instanceof HttpResponseBase) {
            ...
            return _observableThrow(
              response_
            ) as any as Observable<ResultOfGetActiveProductsResponse>;
        })
      );
  }

  protected processGetActive(
    response: HttpResponseBase
  ): Observable<ResultOfGetActiveProductsResponse> {
    const status = response.status;
    const responseBlob =
  ...
  search(
    ...
    page: number | undefined,
    pageSize: number | undefined
  ): Observable<ResultOfSearchProductsResponse> {
...
export class ProductVariantClient {
  ...
  updateVariant(
    ...
    if (variantId === null) throw new globalThis.Error("The parameter 'variantId' cannot be null.");
  ...
  createVariantWithFile(
    ...
    weight: number | null | undefined,
    dimensions: string | null | undefined,
    imageFile: FileParameter | null | undefined
  ): Observable<ResultOfBoolean> {
    ...
    if (sku !== null && sku !== undefined) content_.append('Sku', sku.toString());
...
export class PurchaseOrderClient {
  ...
  updatePurchaseOrderStatus(
    ...
    command: UpdatePurchaseOrderStatusCommand
  ): Observable<FileResponse> {
...
export class UserAddressClient {
      ...
      .pipe(
        _observableCatch((response_: any) => {
          if (response_ instanceof HttpResponseBase) {
            ...
            return _observableThrow(
              response_
            ) as any as Observable<ResultOfPagedResultOfUserAddress>;
        })
      );
  }
  ...
  protected processGetByUser(
    response: HttpResponseBase
  ): Observable<ResultOfPagedResultOfUserAddress> {
    const status = response.status;
    const responseBlob =
      response instanceof HttpResponse
        ? response.body
...
export class UserClient {
    ...
    return this.http
      ...
      .pipe(
        _observableCatch((response_: any) => {
          ...
          } else return _observableThrow(response_) as any as Observable<ResultOfUser>;
        })
      );
  }
  ...
  getByEmail(email: string | undefined): Observable<ResultOfUser> {
    ...
    if (email === null) throw new globalThis.Error("The parameter 'email' cannot be null.");
...
export class UserRoleAssignmentClient {
  ...
  getAssignmentsByUser(
    userId: string,
    request: PagedRequest
  ): Observable<ResultOfPagedResultOfUserRoleAssignment> {
        ...
        _observableCatch((response_: any) => {
          if (response_ instanceof HttpResponseBase) {
            try {
              ...
              return _observableThrow(
                e
              ) as any as Observable<ResultOfPagedResultOfUserRoleAssignment>;
            }
          } else
            return _observableThrow(
              response_
  ...
  protected processGetAssignmentsByUser(
    response: HttpResponseBase
  ): Observable<ResultOfPagedResultOfUserRoleAssignment> {
    const status = response.status;
    const responseBlob =
    ...
    return this.http
      ...
      .pipe(
        _observableCatch((response_: any) => {
          ...
          } else return _observableThrow(response_) as any as Observable<ResultOfUserRole>;
        })
      );
  }
    ...
    return this.http
      ...
      .pipe(
        _observableCatch((response_: any) => {
          ...
          } else return _observableThrow(response_) as any as Observable<ResultOfListOfUserRole>;
        })
      );
  }
...
export class UserSessionClient {
      ...
      .pipe(
        _observableCatch((response_: any) => {
          if (response_ instanceof HttpResponseBase) {
            ...
            return _observableThrow(
              response_
            ) as any as Observable<ResultOfPagedResultOfUserSession>;
        })
      );
  }
  ...
  protected processGetByUser(
    response: HttpResponseBase
  ): Observable<ResultOfPagedResultOfUserSession> {
    const status = response.status;
    const responseBlob =
      response instanceof HttpResponse
        ? response.body
  ...
  protected processGetActiveByUser(
    response: HttpResponseBase
  ): Observable<ResultOfPagedResultOfUserSession> {
    const status = response.status;
    const responseBlob =
...
export class WishlistClient {
  ...
  protected processGetUserWishlistItems(
    response: HttpResponseBase
  ): Observable<ResultOfPagedResultOfWishlistItemDto> {
    const status = response.status;
    const responseBlob =
...
export class ResultOfPagedResultOfAbandonedCartDto
  implements IResultOfPagedResultOfAbandonedCartDto
{
  isSuccess?: boolean;
  ...
  init(_data?: any) {
    if (_data) {
      ...
      this.data = _data['data']
        ? PagedResultOfAbandonedCartDto.fromJS(_data['data'])
        : (undefined as any);
  ...
  init(_data?: any) {
    if (_data) {
      if (Array.isArray(_data['items'])) {
        this.items = [] as any;
        for (let item of _data['items']) this.items!.push(AbandonedCartDto.fromJS(item));
      }
...
export class AbandonedCartDto implements IAbandonedCartDto {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      this.lastActivity = _data['lastActivity']
        ? new Date(_data['lastActivity'].toString())
        : (undefined as any);
      this.createdAt = _data['createdAt']
        ? new Date(_data['createdAt'].toString())
        : (undefined as any);
      this.recoveredAt = _data['recoveredAt']
        ? new Date(_data['recoveredAt'].toString())
        : (undefined as any);
...
export class MarkCartsNotifiedRequest implements IMarkCartsNotifiedRequest {
  ...
  init(_data?: any) {
    if (_data) {
      if (Array.isArray(_data['abandonedCartIds'])) {
        ...
        for (let item of _data['abandonedCartIds']) this.abandonedCartIds!.push(item);
      }
    }
  }
  ...
  toJSON(data?: any) {
    ...
    if (Array.isArray(this.abandonedCartIds)) {
      ...
      for (let item of this.abandonedCartIds) data['abandonedCartIds'].push(item);
    }
    return data;
  }
}
...
export class ResultOfPagedResultOfWishlistItemDto implements IResultOfPagedResultOfWishlistItemDto {
  ...
  init(_data?: any) {
    if (_data) {
      this.isSuccess = _data['isSuccess'];
      this.data = _data['data']
        ? PagedResultOfWishlistItemDto.fromJS(_data['data'])
        : (undefined as any);
      this.errorMessage = _data['errorMessage'];
      this.errorCode = _data['errorCode'];
      if (Array.isArray(_data['errors'])) {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      this.imageFile = _data['imageFile']
        ? FileUploadDto.fromJS(_data['imageFile'])
        : (undefined as any);
      if (Array.isArray(_data['attributes'])) {
        this.attributes = [] as any;
        for (let item of _data['attributes'])
...
export class ResultOfGetProductBySkuResponse implements IResultOfGetProductBySkuResponse {
  ...
  init(_data?: any) {
    if (_data) {
      this.isSuccess = _data['isSuccess'];
      this.data = _data['data']
        ? GetProductBySkuResponse.fromJS(_data['data'])
        : (undefined as any);
      this.errorMessage = _data['errorMessage'];
      this.errorCode = _data['errorCode'];
      if (Array.isArray(_data['errors'])) {
...
export class GetProductBySkuResponse
  extends ProductBaseResponse
  implements IGetProductBySkuResponse
{
...
export class ResultOfGetProductBySlugResponse implements IResultOfGetProductBySlugResponse {
  ...
  init(_data?: any) {
    if (_data) {
      this.isSuccess = _data['isSuccess'];
      this.data = _data['data']
        ? GetProductBySlugResponse.fromJS(_data['data'])
        : (undefined as any);
      this.errorMessage = _data['errorMessage'];
      this.errorCode = _data['errorCode'];
      if (Array.isArray(_data['errors'])) {
...
export class GetProductBySlugResponse
  extends ProductBaseResponse
  implements IGetProductBySlugResponse
{
...
export class ResultOfGetFeaturedProductsResponse implements IResultOfGetFeaturedProductsResponse {
  ...
  init(_data?: any) {
    if (_data) {
      this.isSuccess = _data['isSuccess'];
      this.data = _data['data']
        ? GetFeaturedProductsResponse.fromJS(_data['data'])
        : (undefined as any);
      this.errorMessage = _data['errorMessage'];
      this.errorCode = _data['errorCode'];
      if (Array.isArray(_data['errors'])) {
...
export class GetFeaturedProductsResponse
  extends ProductBaseResponse
  implements IGetFeaturedProductsResponse
{
...
export class ResultOfGetActiveProductsResponse implements IResultOfGetActiveProductsResponse {
  ...
  init(_data?: any) {
    if (_data) {
      this.isSuccess = _data['isSuccess'];
      this.data = _data['data']
        ? GetActiveProductsResponse.fromJS(_data['data'])
        : (undefined as any);
      this.errorMessage = _data['errorMessage'];
      this.errorCode = _data['errorCode'];
      if (Array.isArray(_data['errors'])) {
...
export class GetActiveProductsResponse
  extends ProductBaseResponse
  implements IGetActiveProductsResponse
{
...
export class ResultOfListOfRefreshToken implements IResultOfListOfRefreshToken {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data['data'])) {
        this.data = [] as any;
        for (let item of _data['data']) this.data!.push(RefreshToken.fromJS(item));
      }
      this.errorMessage = _data['errorMessage'];
      this.errorCode = _data['errorCode'];
      if (Array.isArray(_data['errors'])) {
...
export class ResultOfPagedResultOfUserAddress implements IResultOfPagedResultOfUserAddress {
  ...
  init(_data?: any) {
    if (_data) {
      this.isSuccess = _data['isSuccess'];
      this.data = _data['data']
        ? PagedResultOfUserAddress.fromJS(_data['data'])
        : (undefined as any);
      this.errorMessage = _data['errorMessage'];
      this.errorCode = _data['errorCode'];
      if (Array.isArray(_data['errors'])) {
...
export class PagedResultOfUserAddress implements IPagedResultOfUserAddress {
  ...
  init(_data?: any) {
    if (_data) {
      if (Array.isArray(_data['items'])) {
        this.items = [] as any;
        for (let item of _data['items']) this.items!.push(UserAddress.fromJS(item));
      }
      this.totalCount = _data['totalCount'];
      this.page = _data['page'];
      this.pageSize = _data['pageSize'];
...
export class ResultOfPagedResultOfUserRoleAssignment
  implements IResultOfPagedResultOfUserRoleAssignment
{
  isSuccess?: boolean;
  ...
  init(_data?: any) {
    if (_data) {
      this.isSuccess = _data['isSuccess'];
      this.data = _data['data']
        ? PagedResultOfUserRoleAssignment.fromJS(_data['data'])
        : (undefined as any);
      this.errorMessage = _data['errorMessage'];
      this.errorCode = _data['errorCode'];
      if (Array.isArray(_data['errors'])) {
...
export class PagedResultOfUserRoleAssignment implements IPagedResultOfUserRoleAssignment {
  ...
  init(_data?: any) {
    if (_data) {
      if (Array.isArray(_data['items'])) {
        this.items = [] as any;
        for (let item of _data['items']) this.items!.push(UserRoleAssignment.fromJS(item));
      }
      this.totalCount = _data['totalCount'];
      this.page = _data['page'];
      this.pageSize = _data['pageSize'];
...
export class PagedResultOfUserRole implements IPagedResultOfUserRole {
  ...
  init(_data?: any) {
    if (_data) {
      if (Array.isArray(_data['items'])) {
        this.items = [] as any;
        for (let item of _data['items']) this.items!.push(UserRole.fromJS(item));
      }
      this.totalCount = _data['totalCount'];
      this.page = _data['page'];
      this.pageSize = _data['pageSize'];
...
export class ResultOfListOfUserRole implements IResultOfListOfUserRole {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      if (Array.isArray(_data['data'])) {
        this.data = [] as any;
        for (let item of _data['data']) this.data!.push(UserRole.fromJS(item));
      }
      this.errorMessage = _data['errorMessage'];
      this.errorCode = _data['errorCode'];
      if (Array.isArray(_data['errors'])) {
...
export class ResultOfPagedResultOfUserSession implements IResultOfPagedResultOfUserSession {
  ...
  init(_data?: any) {
    if (_data) {
      this.isSuccess = _data['isSuccess'];
      this.data = _data['data']
        ? PagedResultOfUserSession.fromJS(_data['data'])
        : (undefined as any);
      this.errorMessage = _data['errorMessage'];
      this.errorCode = _data['errorCode'];
      if (Array.isArray(_data['errors'])) {
...
export class PagedResultOfUserSession implements IPagedResultOfUserSession {
  ...
  init(_data?: any) {
    if (_data) {
      if (Array.isArray(_data['items'])) {
        this.items = [] as any;
        for (let item of _data['items']) this.items!.push(UserSession.fromJS(item));
      }
      this.totalCount = _data['totalCount'];
      this.page = _data['page'];
      this.pageSize = _data['pageSize'];
